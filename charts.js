// js/charts.js — инициализация и обновление графиков Chart.js

let districtChart = null;

// ─── Утилита: цвет → rgba с заданной прозрачностью ───
